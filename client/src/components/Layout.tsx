...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-gray-100 dark:bg-[#101622]">
      ...
      {/* Sidebar */}
      <aside className={`${isCollapsed ? 'w-20' : 'w-64'} border-r border-gray-200 dark:border-gray-800 flex flex-col h-screen bg-white dark:bg-[#101622] shrink-0 transition-all duration-300 ease-in-out relative`}>
        ...
        {/* Logo Section */}
        <div className={`p-6 flex items-center gap-3 ${isCollapsed ? 'justify-center px-4' : ''}`}>
        ...
        <nav className="flex-1 px-4 space-y-1 mt-4">
          ...
          >
            ...
            {!isCollapsed && <p className="text-sm font-medium">Rooms</p>}
          </Link>
          ...
          >
            ...
            {!isCollapsed && <p className="text-sm font-medium">Bookings</p>}
          </Link>
          ...
          >
            ...
            {!isCollapsed && <p className="text-sm font-medium">Inventory</p>}
          </Link>
          ...
          >
            ...
            {!isCollapsed && <p className="text-sm font-medium">Reports</p>}
          </Link>
